...
export default function BusinessCodePage() {
  const data = {
    logoUrl:
  ...
  const contactDetails = {
    phone: "5551234567",
    countryCode: "+1",
    email: "dd-detailing@gmail.com",
    location: "https://maps.app.goo.gl/ftPuZj8KgCx1GExn6",
  };

  return (
    <>
      <Layout>
        <div className="grid grid-cols-4 gap-5 w-full mt-4 px-4">
          ...
          <div className="flex flex-col gap-4 ">
            <div className="ring-1 ring-light-base p-5 rounded-[8px]">
              ...
              <div className="flex gap-5 items-center">
                ...
                <p>{`${contactDetails.countryCode} ${contactDetails.phone}`}</p>
              </div>
              <div className="flex gap-5 items-center">
